...
This document keeps the GitHub repository presentation and release discipline
aligned with the actual project state.
...
This means the GitHub metadata should describe the project as already built and
deployed, not as a future frontend idea.

## Repository Metadata Baseline

Recommended repository description:

> Bilingual Austrian LAP study base for Applikationsentwicklung - Coding:
> German-first static site, Hungarian canonical Markdown source, explicit
> primary sources.
...
Use releases for milestone checkpoints, not for every content typo or UI polish
commit.
