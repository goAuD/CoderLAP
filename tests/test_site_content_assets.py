...
class SiteContentAssetsTests(unittest.TestCase):
    def test_english_ui_strings_and_legal_content_sources_exist(self) -> None:
        ...
        self.assertEqual(ui_strings["module_pack_label"], "Print pack")
        self.assertEqual(ui_strings["module_pack_print_label"], "Print module pack")
        self.assertEqual(ui_strings["module_pack_contents_label"], "Included topics")
