...
class TemplateHookTests(unittest.TestCase):
    ...
    def test_site_js_wires_progressive_enhancement_hooks(self) -> None:
        ...
        self.assertIn('function normalizeSiteRoot(value)', self.site_js)
        self.assertIn('function sanitizePathSegment(value)', self.site_js)
        self.assertIn('function buildTopicHref(slug)', self.site_js)
        self.assertIn('function buildModulePackHref(packSlug)', self.site_js)
        ...
        self.assertIn('titleLink.href = buildTopicHref(item.slug);', self.site_js)
        self.assertIn('action.href = buildModulePackHref(mainTopic.pack_slug);', self.site_js)
        self.assertIn('link.href = buildTopicHref(topic.slug);', self.site_js)
        ...
        self.assertNotIn("'Sidebar'", self.site_js)
        self.assertNotIn('setAttribute("href", SITE_ROOT + "topics/" + item.slug + "/")', self.site_js)
        self.assertNotIn('setAttribute("href", SITE_ROOT + "module-packs/" + mainTopic.pack_slug + "/")', self.site_js)
        self.assertNotIn('setAttribute("href", SITE_ROOT + "topics/" + topic.slug + "/")', self.site_js)
